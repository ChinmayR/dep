...
func (c *multiCache) getPackageTree(r Revision, pr ProjectRoot) (pkgtree.PackageTree, bool) {
	uber.CacheLogger.Printf("executing multi getPackageTree, rev:%v, projectRoot:%v", r, pr)
	...
	uber.CacheLogger.Printf("miss multi getPackageTree, rev:%v, projectroot:%v", r, pr)
