...
var pathDeductionFixtures = map[string][]pathDeductionFixture{
	"github": {
		...
		},
		{
			...
			root: "github.com/sdboyer/gps",
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/github/sdboyer/gps"),
		...
		},
		{
			...
			root: "github.com/sdboyer/gps.git",
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/github/sdboyer/gps.git"),
		...
		},
		{
			...
			root: "github.com/a/gps",
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/github/a/gps"),
		...
		},
		{
			...
			root: "github.com/kr/pretty",
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/github/kr/pretty"),
	...
	"gopkg.in": {
		...
		},
		{
			...
			root: "gopkg.in/sdboyer/gps.v0",
			mb: maybeSources{
				maybeGopkginSource{opath: "gopkg.in/sdboyer/gps.v0",
		...
		},
		{
			...
			root: "gopkg.in/sdboyer/gps.v1",
			mb: maybeSources{
				maybeGopkginSource{opath: "gopkg.in/sdboyer/gps.v1",
		...
		},
		{
			...
			root: "gopkg.in/yaml.v1",
			mb: maybeSources{
				maybeGopkginSource{opath: "gopkg.in/yaml.v1",
		...
		},
		{
			...
			root: "gopkg.in/inf.v0",
			mb: maybeSources{
				maybeGopkginSource{opath: "gopkg.in/inf.v0",
	...
	"golang.org": {
		...
		},
		{
			...
			root: "golang.org/x/exp",
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/googlesource/exp"),
		...
		},
		{
			...
			root: "golang.org/x/net",
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/googlesource/net"),
		...
		},
		{
			...
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/googlesource/mobile"),
		...
		},
		{
			...
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/googlesource/sys"),
	...
	"code.uber.internal": {
		{
			...
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/devexp/version-set-poc.git"),
		...
		},
		{
			...
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/devexp/crashagg.git"),
		...
		},
		{
			...
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/devexp/crashagg"),
		...
		},
		{
			...
			mb: maybeSources{
				maybeGitoliteSource{url: mkurl("ssh://gitolite@code.uber.internal/infra/stapi-gocql.git"),
			...
			for _, fix := range fixtures {
				...
				t.Run(fix.in, func(t *testing.T) {
					...
					if fix.runUberLogic == true {
						RunUberDeduceLogicForTest = true
						defer func() { RunUberDeduceLogicForTest = false }()
					}
...
func TestGitolitePathAsFullUrl(t *testing.T) {
	...
	goturl, wanturl := pd.mb[0].(maybeGitoliteSource).url.String(), "ssh://gitolite@code.uber.internal/infra/stapi-gocql.git"
	if goturl != wanturl {
		t.Errorf("Deduced repo ident does not match fixture:\n\t(GOT) %s\n\t(WNT) %s", goturl, wanturl)
	}
}
